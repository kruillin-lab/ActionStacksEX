...
public static unsafe class Game
{
    ...
    public static readonly AsmPatch allowUnassignableActionsPatch = new("75 07 32 C0 E9 ?? ?? ?? ?? 48 8B 00", [ 0xEB ], ActionStacksEX.Config.EnableUnassignableActions);
    ...
    public static readonly AsmPatch waitSyntaxDecimalPatch = new("F3 0F 58 05 ?? ?? ?? ?? F3 48 0F 2C C0 69 C8",
        ...
        ActionStacksEX.Config.EnableFractionality);
    ...
    public static readonly AsmPatch queueACCommandPatch = new("02 00 00 00 41 8B D7 89", [ 0x64 ], ActionStacksEX.Config.EnableMacroQueue);
    ...
    {
        if (ActionStacksEX.Config.AutoFocusTargetID == 0 || DalamudApi.TargetManager.FocusTarget == null || DalamudApi.TargetManager.FocusTarget.Equals(DalamudApi.ObjectTable.FirstOrDefault(o => o.DataId == FocusTargetInfo.DataID && o.Name.ToString() == FocusTargetInfo.Name)))
    ...
    {
        if (ActionStacksEX.Config.EnableMacroQueue)
