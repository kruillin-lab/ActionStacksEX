...
public unsafe class Decombos : PluginModule
{
    ...
    private static ActionID GetAdjustedActionIdDetour(ActionManager* actionManager, ActionID actionID)
    {
        ...
        switch (actionID)
        {
            case ActionID.Meditation when ActionStacksEX.Config.EnableDecomboMeditation:
                return actionID;
            case ActionID.The_Forbidden_Chakra when ActionStacksEX.Config.EnableDecomboMeditation:
            case ActionID.Steel_Peak when ActionStacksEX.Config.EnableDecomboMeditation:
                return ret != ActionID.Meditation ? ret : actionID;

            case ActionID.Bunshin when ActionStacksEX.Config.EnableDecomboBunshin:
            case ActionID.Phantom_Kamaitachi when ActionStacksEX.Config.EnableDecomboBunshin:
                return actionID;

            case ActionID.The_Wanderers_Minuet when ActionStacksEX.Config.EnableDecomboWanderersMinuet:
                return actionID;

            case ActionID.Liturgy_of_the_Bell when ActionStacksEX.Config.EnableDecomboLiturgy:
                return actionID;

            case ActionID.Earthly_Star when ActionStacksEX.Config.EnableDecomboEarthlyStar:
                return actionID;

            case ActionID.Minor_Arcana when ActionStacksEX.Config.EnableDecomboMinorArcana:
                return actionID;
            case ActionID.Lord_of_Crowns when ActionStacksEX.Config.EnableDecomboMinorArcana:
            case ActionID.Lady_of_Crowns when ActionStacksEX.Config.EnableDecomboMinorArcana:
            ...
            case ActionID.Geirskogul when ActionStacksEX.Config.EnableDecomboGeirskogul:
                return actionID;
